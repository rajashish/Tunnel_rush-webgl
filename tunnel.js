function initTunnel(gl) {
    ...
    // Now create an array of positions for the tunnel.
    //radius of tunnel 
    var r = 2.5;
    ...
    const faceColors = [
        ...
        [0.3,  0.6,  0.7,  1.0],    // Left face: purple
    ];
...
// Draw the scene.
//
function drawScene_tunnel( programInfo, buffers, deltaTime, texture1) {
    ...
    for (var i = 0; i < 1100; i++) {
        ...
        mat4.translate(modelViewMatrix,     // destination matrix
            ...
            [-0.0, 0.0, -2*i+tunnelTranslation]);  // amount to translate
        ...
        mat4.rotate(modelViewMatrix,  // destination matrix
            ...
            i*135*Math.PI/180.0+tunnelRotation,     // amount to rotate in radians
